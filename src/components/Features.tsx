            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Crie álbuns digitais com fotos, vídeos e textos que capturam 
                    a essência e os momentos especiais dos seus entes queridos.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Registre biografias, histórias e relatos que mantêm vivos os 
                    valores, ensinamentos e conquistas de quem partiu.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Compartilhe recordações com familiares e amigos próximos, 
                    controlando quem pode ver e contribuir para as memórias.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Acesso a psicólogos parceiros especializados em luto, 
                    oferecendo suporte profissional durante o processo de perda.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Participe de grupos moderados onde pessoas em situações 
                    semelhantes podem compartilhar experiências e encontrar conforto.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Conteúdos e guias sobre o processo de luto, com técnicas de 
                    mindfulness e práticas para o equilíbrio emocional.
                  </p>
                </div>
              </div>
            </div>
