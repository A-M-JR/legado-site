    ...
    <section className="py-24 bg-legado-mid bg-opacity-10 from-legado-mid/20 via-legado-mid/10 to-transparent">
      <div className="container mx-auto px-6 lg:px-8">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl md:text-5xl font-serif font-bold text-legado-dark mb-8 leading-tight">
            ILC – Instituto Legado e Conforto. <span className="text-legado-gold">Porque toda vida merece ser lembrada com carinho.</span>
          </h2>

          <p className="text-base md:text-lg text-legado-dark font-medium mb-12 leading-relaxed max-w-3xl mx-auto text-justify">
            ...
            <br /><br />
            Com o ILC, você eterniza memórias com amor. Sejam todos bem vindos ao nosso Legado.
          </p>

          <a
            href="#contato"
            className="inline-flex items-center justify-center bg-legado-gold text-white px-10 py-5 rounded-full shadow-2xl shadow-legado-gold/30 hover:bg-legado-dark transition-all duration-300 ease-out hover:scale-105 font-bold text-lg"
          >
